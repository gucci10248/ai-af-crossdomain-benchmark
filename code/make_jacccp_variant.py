...
Results. Internal discrimination was high (area under the receiver operating characteristic curve 0.974) with acceptable calibration (Brier score 0.069; expected calibration error 0.065). On transfer to the wearable cohort, discrimination fell modestly (0.885) whereas calibration degraded threefold (Brier 0.221; error 0.225) and sensitivity at 90% specificity fell from 0.945 to 0.586. Transfer to the Chinese cohort was better (0.946; 0.871). Most loss came from noisy segments (0.630; 0.166) rather than other rhythms or population. Recalibration repaired probabilities but not discrimination. At 1% prevalence the external operating point yielded a positive predictive value of 2.8%, versus 66.0% for an algorithm validated at 99.5% specificity.
...
CONDENSED = """In three openly available cohorts harmonized onto one 30-second single-lead task, transferring an atrial fibrillation detection model from a clinical 12-lead dataset to a consumer wearable cohort left discrimination almost intact (area under the curve 0.974 to 0.885) while calibration error tripled and sensitivity at 90% specificity fell from 0.945 to 0.586. Most false positives came from noisy segments. At 1% prevalence, the resulting positive predictive value was 2.8%, against 66.0% for an algorithm validated at 99.5% specificity, so device change, not population change, is what breaks screening performance."""
